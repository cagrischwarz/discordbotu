...
const girismesaj = [
  '**Schizophren BOT sunucunuza eklendi!**',
  '**Schizophren BOT** sunucunuzdaki insanlara kolaylıklar sağlar.',
  'Bot Çağrı (Rio) tarafından geliştirilmektedir ',
  ...
  '',
  `**Sohbet ve Oyun Discord Sunucusu** https://discord.gg/xTQSKUW`
]
